...
- It does not ask for a PAT, copy Chrome/Edge cookies, export cookies or serialize credentials. Browsing URLs are kept in memory and are not saved in plugin preferences. Selecting and copying the address, or pressing Copy URL, explicitly puts the full URL on the IDE/system clipboard; clipboard history follows your IDE and OS settings.
